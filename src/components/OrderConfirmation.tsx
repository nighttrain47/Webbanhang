      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            ...
            <p className="text-2xl font-bold text-[#FF9900]">{orderNumber}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-orange-50 rounded-lg p-4">
              <Award className="w-6 h-6 text-[#FF9900] mx-auto mb-2" />
          ...
          <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg p-6 mb-8 text-left">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex gap-3">
                <div className="w-6 h-6 bg-[#FF9900] text-white rounded-full flex items-center justify-center shrink-0 font-bold">
                  1
                </div>
          ...
          <div className="mt-8 pt-6 border-t text-sm text-gray-600">
            ...
            <a href="mailto:support@animeshop.com" className="text-[#FF9900] hover:underline font-semibold">
        ...
        <div className="mt-8 bg-white rounded-2xl shadow-lg p-6">
          ...
          <Link
            to="/"
            className="inline-block mt-4 text-[#FF9900] hover:underline font-semibold"
          >
            Xem sản phẩm mới →
          </Link>
        </div>
